...
import com.bruno.projectMc.services.CategoryService;
...
public class CategoryResource {
	...
	public ResponseEntity<Page<CategoryDTO>> findPage(
			...
			@RequestParam(value="orderBy", defaultValue= "name") String orderBy, @RequestParam(value="direction", defaultValue= "ASC")String direction) {
